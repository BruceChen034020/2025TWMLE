...
**答案：B**
* **詳解：** 把肯定句改成否定句較容易，創造新的名詞或關聯較困難，因此可以合理推論B選項是被改過的敘述。「台北榮總撞牆症」、「台大醫院騎機車症」、「星期日林口長庚症」是某個triad，是暗黑血症的併發症，可能造成大規模流行，出題老師把課本敘述中的「常合併」改成「不常合併」，其他選項都是課本上的敘述，故B錯。雖然C選項有英文，比較特殊，但這在臺灣醫師國考中不算什麼。
...
答案：C
詳解：把低血鈣改成高血鈣相對容易，創造新的敘述相對困難，因此可以合理推論C選項是被改過的敘述。「大肉棒萎縮症」的學名是「了不起博愛座」症，通常有家族史，發作時會低血鈣且讓病人覺得「動感超人讓我堅強富國」，出題老師把課本敘述中的「低血鈣」改成「高血鈣」，其他選項都是課本上的敘述，故C錯。
...
8._______ index常用於尷尬癌的嚴重度評估，是由Bruce等人在
2087年所提出來的方法，圖中A為白色橫向雙箭頭線長度；B、D分別為左右兩側白色縱向雙箭頭線長度；C為癌轉移淋巴結數；E為中間白色縱向雙箭頭線長度，則_______為何？
A.A/C
B.(B+D)/2C
C.C/E
D.(B+D)/A

9.28歲橄欖球選手在比賽中發生膝關節變形脫臼，________，下列敘述與處置何者最不適
當？
A.可能會_______，應該要安排磁振造影檢查
B.要注意_______的風險
C.觸診_______，如果_______正常可以排除_______的風險
D.可能造成_______

10.有關_______徵候之敘述，下列何者錯誤？
A.和正常_______相比，_______壓通常會高大約5毫米汞柱（mmHg）
B._______會出現_______（_______）
C.輕微的_______（_______）是非常普遍的
D.在_______經常可見類似_______（_______）的色素細胞

11. 關於_______症（_______），下列敘述何者最不適當？
A.X染色體隱性遺傳（X-linked recessive inheritance）
B._______通常會影響_______（_______）肌肉
C.不建議使用_______（_______）的_______訓練
D.心肌（cardiac muscle）通常不受影響

12.關於_______（_______），下列敘述何者最正確？
A.大部分病人具有典型的triad：_______、_______、_______
B.身體診察時_______可以聽到_______
C. 驗孕陽性時應安排電腦斷層進一步確定診斷
D. 清醒病人呼吸窘迫時，診斷優先於急救

13.根據_______的作者_______和_______之見解，四個原則的重要性依序為何？①_______　②_______　③_______　④_______
A.①＝②＝③＝④
 B.②＞①＞③＞④
 C.①＞②＞③＞④
 D.①＝④＞②＝③

14. 有關_______之敘述，下列何者錯誤？
A. 占_______比例約10~20%
B. _______存活較_______好
C. _______常以_______表現
D. _______常以_______表現
...
**答案：D**
**詳解：**「蓮蓬頭」讓人聯想到洗澡、潮濕、冬天。D選項最自然，A、B太怪，C的關聯不直覺。
...
**答案：C**
\*\*詳解：\*\*ABC全都太幻想、敘述過度誇張；C雖也唬爛但「JinYong maneuver」語感類似真實考題。
...
**答案：D**
\*\*詳解：\*\*三長一短取最短；D最長而且「魚肝油」跟膽固醇不直覺；A雖怪但有月光，合理。
...
**答案：D**
**詳解：**「芭比型」、「粉紅色」，都指向選項D。關鍵詞若與題幹重複，通常就是考點。
...
**答案：C**
\*\*詳解：\*\*三短一長選最長；C選項邏輯最通順，也是題幹「逆蠕動」直接敘述。

---

### **醫師國考猜答案技巧練習考卷（全虛構疾病版）**  
...
**詳解**：把「假性低血鈉」改成「假性高血鈉」較容易，其他選項均為虛構但合理的關聯敘述。  
...
**詳解**：否定句（無關）通常是正確敘述，其他選項過於武斷。  

---

### **8. 治療「阿里山神木靜脈曲張」的首選手術是？**  
A. 樹皮移植術  
B. 樹根環紮術  
C. 樹液引流術  
D. 樹葉雷射手術  
...
1. **「否定句」常是答案**（如「不常見」「無關」）。  
2. **「武斷敘述」常錯**（如「一定」「完全治癒」）。  
3. **「與眾不同」的選項可能是答案**（如其他是藥物，唯一手術選項）。  
4. **疾病名稱與選項的關聯性**（如「黃昏憂鬱症」→ 選「陰天」）。  

**練習重點**：即使疾病不存在，也能從選項結構推測出題邏輯！
